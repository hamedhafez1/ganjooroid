...
public class GanjoorDatabaseDownloaderActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mainView.setOrientation(LinearLayout.VERTICAL/*VERTICAL*/);
        ...
        _contentView.setOrientation(LinearLayout.VERTICAL/*VERTICAL*/);
            ...
            for (GDBInfo Item : list._Items) {
                ...
                if (installed) {
                    ...
                    if (!addedBreaker) {
                        ...
                        llItem.setOrientation(LinearLayout.VERTICAL/*VERTICAL*/);
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            ...
            case ID_DLG_INSTALLGDBFAILED: {//دیالو گ اعلام خطای دریافت لیست مجموعه ها
